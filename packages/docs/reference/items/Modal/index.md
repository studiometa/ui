...
::: warning Deprecated
The `Modal` component is deprecated and will be removed in a future release. Use the [`Dialog`](/reference/items/Dialog/) component instead — it is headless, built on the native `<dialog>` element and driven by [`Action`](/reference/items/Action/).
:::
