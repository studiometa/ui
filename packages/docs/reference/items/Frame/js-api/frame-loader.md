...
The `FrameLoader` component extends the [`Transition` component](/reference/items/Transition/) and inherits its APIs, with the exception of the [`enterKeep`](/reference/items/Transition/js-api.md#enterkeep) and [`leaveKeep`](/reference/items/Transition/js-api.md#/reference/items/Transition/js-api.md#enterkeep) options which are force to be always `true`.
