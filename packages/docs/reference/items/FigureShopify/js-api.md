...
The `FigureShopify` class extends the [`Figure` class](/reference/items/Figure/js-api.md) and formats image sources for the [Shopify CDN image API](https://shopify.dev/docs/api/liquid/filters/image_url).
