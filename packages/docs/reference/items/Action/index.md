...
In the following example, the buttons each have an `Action` component targeting the [`Transition`](/reference/items/Transition/index.html) component in the page.
