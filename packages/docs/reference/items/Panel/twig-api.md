...
The `Panel` component extends the [`Modal` component](/reference/items/Modal/twig-api.md) and inherits all its parameters and blocks.
...
All parameters from the [Modal component](/reference/items/Modal/twig-api.md) are available:
...
All blocks from the [Modal component](/reference/items/Modal/twig-api.md) are inherited:
