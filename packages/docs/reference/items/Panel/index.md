...
::: warning Deprecated
The `Panel` component is deprecated and will be removed in a future release. Use the [`Dialog`](/reference/items/Dialog/) component instead — a drawer is a documented `Dialog` pattern, see [Building a drawer](/reference/items/Dialog/#building-a-drawer).
:::
