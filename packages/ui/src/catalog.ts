...
const components: readonly CuratedComponentMetadata[] = [
  ...
  { token: 'CarouselCount', group: 'carousel' },
  { token: 'CarouselDots', group: 'carousel' },
  { token: 'CarouselDrag', group: 'carousel' },
  { token: 'CarouselItem', group: 'carousel' },
  { token: 'CarouselPlay', group: 'carousel' },
  { token: 'CarouselProgress', group: 'carousel' },
  { token: 'CarouselThumbnails', group: 'carousel' },
