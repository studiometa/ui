...
/**
 * Build a {@link ComponentManifest} from a record of lazy importers — the pure counterpart of the
 * generated per-package manifests, for app developers autoloading their own js-toolkit components.
 *
