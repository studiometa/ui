...
import { SliderDots } from '#private/Slider/SliderDots.js';
...
function active(buttons: HTMLButtonElement[]): boolean[] {
  return buttons.map((button) => button.classList.contains('is-active'));
}
