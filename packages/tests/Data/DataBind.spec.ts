...
import { EVENTS, getInstance, registerComponents } from '@studiometa/js-toolkit';
import { captureDiagnostics, mount, resetDom, settle } from '@studiometa/js-toolkit/test';
import { DataBind } from '#private/Data/DataBind.js';
import { DataComputed } from '#private/Data/DataComputed.js';
import { DataEffect } from '#private/Data/DataEffect.js';
import { DataModel } from '#private/Data/DataModel.js';
import { DataScope } from '#private/Data/DataScope.js';
import type { DataValue } from '#private/Data/registry.js';
...
class ReentrantBind extends DataBind {
  ...
  override set(value: DataValue, dispatch = true): void {
    ...
    if (!dispatch && value === 'outer' && !this.__dispatched) {
