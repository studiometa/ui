...
test("@studiometa/ui barrel export surface", () => {
  expect(surface(ENTRIES["@studiometa/ui"])).toMatchInlineSnapshot(`
    [
      ...
      "CarouselCount [value]",
      "CarouselCountProps [type]",
      "CarouselDots [value]",
      "CarouselDotsProps [type]",
      "CarouselDrag [value]",
      "CarouselDragProps [type]",
      "CarouselItem [value]",
      "CarouselPlay [value]",
      "CarouselPlayProps [type]",
      "CarouselProgress [value]",
      "CarouselProgressProps [type]",
      "CarouselProps [type]",
      "CarouselScrollPosition [type]",
      "CarouselState [type]",
      "CarouselThumbnails [value]",
      "CarouselThumbnailsProps [type]",
